...
function ProductShow({ productTitle, imgIdx }) {
  ...
  const products = [
    {
      metaTitle: "Cloud-Based Thermal Camera | Fever Screening Solution",
      metaDescription:
        "Thermal Camera offers AI-driven fever screening, remote monitoring & COVID-19 prevention. Ensure safety with accurate & contactless detection.",
    ...
    {
      metaTitle: "Cloud-Based Thermal Camera | Advanced Fever Screening",
      metaDescription:
        "Adiance Technologies Thermal Camera ensures fast, multi-person fever screening with AI & cloud-based monitoring. Ideal for offices, hospitals, malls & airports.",
    ...
    {
      metaTitle: "Thermal Camera  | Multi-Person Fever Screening",
      metaDescription:
        "VMS & VAS Solution, Thermal Camera offers AI-driven fever screening, multi-person monitoring & remote temperature detection for enhanced safety & prevention.",
    ...
    {
      metaTitle: "Edge AI PTZ ANPR Bullet Camera | 4K Smart Surveillance",
      metaDescription:
        "Adiance Edge AI PTZ Bullet Camera with ANPR, facial recognition & low-light clarity. FHD resolution, cloud monitoring & remote access for smart security.",
    ...
    {
      metaTitle: "Edge AI Face Recognition Dome Camera | 4K Smart Security",
      metaDescription:
        "Adiance 4K Face Recognition Dome Camera with AI-powered security, cloud monitoring & low-light clarity. Remote access & FHD streams for precise surveillance",
    ...
    {
      metaTitle: "Edge AI Object & Face Detection CCTV Cameras",
      metaDescription:
        "Enhance security with Edge AI cameras featuring ANPR, facial recognition, cloud monitoring, FHD video, motion detection, and night vision for ultimate surveillance.",
    ...
    {
      metaTitle: "4G Dome PTZ Camera for Wide Area Surveillance ",
      metaDescription:
        "Monitor large areas with Adiance 4G Dome PTZ cameras. Enjoy 24/7 cloud surveillance, easy installation, and cost savings with PTZ capabilities.",
    ...
    {
      metaTitle: "4G Mini Bullet Camera | Smart Cloud Security Solution",
      metaDescription:
        "4G Mini Bullet Camera with 24/7 cloud monitoring, HD streaming, motion detection & wide-angle view. Remote access & cost-effective security solution",
    ...
    {
      metaTitle: "Cloud XVR – Secure & Scalable Video Surveillance",
      metaDescription:
        "Cloud XVR offers secure, cost-effective video storage, management, and analytics, providing flexible surveillance access anytime, anywhere.",
  ...
  return (
    <div>
      <Helmet>
        <title>{productToShow.metaTitle || productToShow.title}</title>

        <meta
          name="description"
          content={productToShow.metaDescription || productToShow.description}
        />
      ...
      <Header />
      <div>
        {productToShow && <NavHeader text={productToShow.title} />}
        {productToShow && (
          <ProductSinglePage product={productToShow} imgIdxSP={imgIdx} />
        )}
      </div>
      <Footer />
    </div>

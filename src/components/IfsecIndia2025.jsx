      ...
      <div className="ifsec-page">
          ...
          <Container>
            <Row>
              <Col lg={12} className="text-center">
                <p className="section-title">Image Gallery</p>
              </Col>
            </Row>
          ...
          <Container>
            <Row>
              <Col lg={12}>
                ...
                <p className="section-description">
                  The exhibition strengthened our position as one of the <a href="https://www.adiance.com/">top AI CCTV technology providers in India</a> and showcased our commitment to delivering scalable, future-ready security solutions across industries.
                </p>
              </Col>
            </Row>
          </Container>
        ...
        <section className="image-gallery-section">
          <Container>
            <Row>
              <Col lg={12} className="text-center">
                <p className="section-title">Moments from IFSEC India 2025</p>
              </Col>
            </Row>
        ...
        <section className="cta-section">
          <Container>
            <Row className="justify-content-center text-center">
              <Col lg={8}>
                <h4 className="cta-title">Book a Demo and Experience India's Most Advanced AI CCTV Solutions</h4>
                <Button
                  variant="primary"
                  className="cta-btn"

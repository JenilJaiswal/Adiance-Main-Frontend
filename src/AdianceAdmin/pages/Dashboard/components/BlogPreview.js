...
const API_IMAGE_URL = "https://backend.adiance.com:443/images" || "http://localhost:5000/uploads";
                              ...
                              component.content.imagePath ? (
                                <Image
                                  src={
                                    component.content.file ||
                                    component.content.url ||
                                    `${API_IMAGE_URL}/${component.content.imagePath}`
                                  }

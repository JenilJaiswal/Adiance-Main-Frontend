...
const DEFAULT_BODY = [
  "Adiance Technologies is an NDAA-compliant OEM and ODM CCTV camera manufacturer headquartered in Ahmedabad, India. We design, engineer, and assemble surveillance cameras on non-Chinese system-on-chip platforms — Qualcomm, Ambarella, Novatek, and Sigmastar — for US Federal, UK, EU, GCC, and global enterprise procurement. Adiance was founded in 2003 and operates a fully owned manufacturing facility with in-house PCB design, SMT assembly, firmware engineering, mechanical design, lens calibration, and QA. The non-Chinese SoC supply chain is fully auditable and documented for US Federal and critical-infrastructure procurement audits.",

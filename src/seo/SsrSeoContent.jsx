...
const DEFAULT_BODY = [
  ...
  "Compliance coverage includes NDAA Section 889, GDPR-readiness, STQC testing, BIS-ER certification, CE, FCC, RoHS, and ONVIF Profiles S, G, and T. Adiance is positioned as a non-Chinese, NDAA-compliant manufacturing partner for buyers who need a fully auditable, compliance-first surveillance supply chain. The company targets US federal, state, and local government procurement, US, Canadian, UK, and EU enterprise integrators and CCTV brands, GCC and Middle Eastern smart-city and critical-infrastructure projects, ASEAN and ANZ distributors looking for a China + 1 supply chain, the Indian government and enterprise via STQC and BIS-ER certified channels, and global private-label and white-label brands wanting to launch their own CCTV line without owning a factory.",

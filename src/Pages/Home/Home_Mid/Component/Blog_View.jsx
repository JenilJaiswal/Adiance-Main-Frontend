    ...
    >
      <VStack align="start" spacing={{ base: 3, md: 4 }} flex="1">
        <Box minH={{ base: "60px", md: "80px", lg: "100px" }} display="flex" alignItems="flex-start">
          <Heading as="h3" size={{ base: "sm", md: "md", lg: "lg" }} lineHeight="1.3">
            {title}
          </Heading>
        </Box>
        <Box width="20px" height="2px" bg="white" borderRadius="full" />
        <Box minH={{ base: "60px", md: "80px", lg: "100px" }} display="flex" alignItems="flex-start">
          <Text fontSize={{ base: "sm", md: "md" }} opacity={0.9} lineHeight="1.6">
            {brief}
          </Text>
        </Box>
      </VStack>
...
const BlogViewContent = () => {
  ...
  // Effect for auto-scrolling carousel on mobile and tablet
  useEffect(() => {
              ...
              <Flex justify="center" mt={4} gap={2}>
                {blogs.map((_, index) => (
                  <Box
                    ...
                    h="10px"
                    borderRadius="50%"
                    bg={currentIndex === index ? "#bf0603" : "gray.300"}
                    cursor="pointer"
                    transition="all 0.3s"
